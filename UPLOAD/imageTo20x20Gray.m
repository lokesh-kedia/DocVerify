...
for i=1:colsPadding(1)
  Image2DmatrixBW = [ones(rows,1) Image2DmatrixBW];
endfor
for i=1:colsPadding(2)
  Image2DmatrixBW = [Image2DmatrixBW ones(rows,1)];
endfor
for i=1:rowsPadding(1)
  Image2DmatrixBW = [ones(1,28);Image2DmatrixBW];
endfor
for i=1:rowsPadding(2)
  Image2DmatrixBW = [Image2DmatrixBW;ones(1,28)];
endfor
size(Image2DmatrixBW);
...
vectorImage = reshape(contrastedImage, 1, 784);
end